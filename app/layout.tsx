...
export const metadata: Metadata = {
  title: "Forge — Where you're built",
  description: "The personal accountability platform for people serious about the gap between where they are and where they're going.",
}
